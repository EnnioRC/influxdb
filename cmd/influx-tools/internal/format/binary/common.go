...
//go:generate protoc -I$GOPATH/src/github.com/EnnioRC/influxdb/vendor -I. --gogofaster_out=Mgoogle/protobuf/empty.proto=github.com/gogo/protobuf/types:. binary.proto
