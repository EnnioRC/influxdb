...
### `influx_stress`
This runs a basic stress test with the [default config](https://github.com/EnnioRC/influxdb/blob/master/stress/stress.toml) For more information on the configuration file please see the default.
...
This runs the stress test with a valid `v2` configuration file. For more information about the `v2` stress test see the [v2 stress README](https://github.com/EnnioRC/influxdb/blob/master/stress/v2/README.md).
...
`default` = [config](https://github.com/EnnioRC/influxdb/blob/master/stress/stress.toml)
