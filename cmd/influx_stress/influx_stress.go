// Command influx_stress is deprecated; use github.com/EnnioRC/influx-stress instead.
package main
...
import (
	...
	"github.com/EnnioRC/influxdb/stress"
	v2 "github.com/EnnioRC/influxdb/stress/v2"
)
