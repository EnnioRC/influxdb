...
func TestCompile_Failures(t *testing.T) {
	for _, tt := range []struct {
		...
		// TODO(jsternberg): This query is wrong, but we cannot enforce this because of previous behavior: https://github.com/EnnioRC/influxdb/pull/8771
		...
		// TODO: Remove this restriction in the future: https://github.com/EnnioRC/influxdb/issues/5968
		...
		// TODO: The error message will change when math is allowed inside an aggregate: https://github.com/EnnioRC/influxdb/pull/5990#issuecomment-195565870
